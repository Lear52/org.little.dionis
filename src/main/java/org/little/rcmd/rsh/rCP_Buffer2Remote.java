...
public class rCP_Buffer2Remote extends rCP{
       ...
       public  rCP_Buffer2Remote(String rfile,String lfile) {
               super(rfile,lfile);
       }
       public rCP_Buffer2Remote(String name,int index,String _rfile,String _lfile) {
	...
	public void setBuffer(byte[] _buffer) {
        ...
        public static void main(String[] arg){
               ...
               rCP_Buffer2Remote  cp0=new rCP_Buffer2Remote("remoute_out.bin","local_out.bin");
